  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setApps([
          { id: "app1", name: "Slackbot", description: "Your friendly digital assistant", icon: "🤖", category: "Core Integrations" },
          { id: "app2", name: "GitHub", description: "Get real-time updates on pull requests", icon: "🐙", category: "Development Tools" },
          { id: "app3", name: "Google Drive", description: "Sharing and storage for all your files", icon: "📂", category: "Cloud Storage" },
          { id: "app4", name: "JIRA Cloud", description: "Better bug tracking for your organization", icon: "🌀", category: "Management" },
          { id: "app5", name: "Dropbox", description: "Keep your team's files in sync", icon: "📦", category: "Cloud Storage" },
          { id: "app6", name: "Trello", description: "Manage project boards right within Slack", icon: "📊", category: "Productivity" },
        ]);
      } catch (err) {
        console.error(err);
      }
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="bg-gradient-to-br from-[#4a154b]/30 to-[#611f69]/30 border border-white/10 rounded-[40px] p-12 flex flex-col md:flex-row items-center gap-10 shadow-3xl backdrop-blur-xl group hover:border-accent/30 transition-all">
                <div className="w-40 h-40 bg-white/5 border border-white/10 rounded-[40px] flex items-center justify-center text-8xl shadow-2xl animate-bob group-hover:rotate-6 transition-transform">
                  🤖
                </div>
                <div className="space-y-6 text-center md:text-left">
                   ...
                   <button 
                     onClick={() => navigate("/chat/slackbot")}
                ...
                {apps.map((app) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-16 h-16 bg-[#1e293b] rounded-2xl flex items-center justify-center text-3xl shadow-xl group-hover:shadow-accent/5 transition-all">
                        {app.icon}
                      </div>
